...
var Chart = function () {
    ...
    function l(t, e) {
        return {x: Math.sin(t * Lt) * e, y: Math.cos(t * Lt) * e}
    }
    ...
    function p(t, e) {
        ...
        for (var n in e) {
            var a = e[n];
            if ("inside" === n)u(a).appendChild(i); else if ("around" === n) {
                var s = u(a);
    ...
    function d(t, e) {
        return p("linearGradient", {inside: t, id: e, x1: 0, x2: 0, y1: 0, y2: 1})
    }

    function f(t, e, i, n) {
        return p("stop", {inside: t, style: "stop-color: " + i, offset: e, "stop-opacity": n})
    }

    function v(t, e, i, n) {
        return p("svg", {className: e, inside: t, width: i, height: n})
    }

    function g(t) {
        return p("defs", {inside: t})
    }
    ...
    function b(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, s = i.x + t.x, r = i.y + t.y, o = i.x + e.x, l = i.y + e.y;
        return "M" + i.x + " " + i.y + "\n\t\tL" + s + " " + r + "\n\t\tA " + n + " " + n + " 0 0 " + (a ? 1 : 0) + "\n\t\t" + o + " " + l + " z"
    }

    function x(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], n = "path-fill-gradient-" + e + "-" + (i ? "lighter" : "default"), a = d(t, n), s = [1, .6, .2];
        return i && (s = [.4, .2, 0]), f(a, "0%", e, s[0]), f(a, "50%", e, s[1]), f(a, "100%", e, s[2]), n
    }

    function k(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "none", s = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {}, r = {
            className: t,
            x: e,
            y: i,
            width: n,
    ...
    function w(t, e, i, n) {
        return p("text", {className: t, x: e, y: i, dy: Ct / 2 + "px", "font-size": Ct + "px", innerHTML: n})
    }

    function A(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {};
        a.stroke || (a.stroke = _t);
        var s = p("line", {
            ...
            "text-anchor": "middle",
            innerHTML: e + ""
        }), o = p("g", {transform: "translate(" + t + ", 0)"});
        return o.appendChild(s), o.appendChild(r), o
    }

    function T(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {};
        a.stroke || (a.stroke = _t), a.lineType || (a.lineType = "");
        var s = p("line", {
            ...
            innerHTML: e + ""
        }), o = p("g", {transform: "translate(0, " + t + ")", "stroke-opacity": 1});
        return 0 !== r && "0" !== r || (o.style.stroke = "rgba(27, 31, 35, 0.6)"), o.appendChild(s), o.appendChild(r), o
    }

    function P(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
        n.pos || (n.pos = "left"), n.offset || (n.offset = 0), n.mode || (n.mode = "span"), n.stroke || (n.stroke = _t), n.className || (n.className = "");
        var a = -1 * Mt, s = "span" === n.mode ? i + Mt : 0;
    ...
    function L(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
        n.pos || (n.pos = "bottom"), n.offset || (n.offset = 0), n.mode || (n.mode = "span"), n.stroke || (n.stroke = _t), n.className || (n.className = "");
        var a = i + Mt, s = "span" === n.mode ? -1 * Mt : i;
    ...
    function M(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, a = p("text", {
            ...
            "text-anchor": "start",
            innerHTML: e + ""
        }), s = T(t, "", 0, i, {stroke: n.stroke || _t, className: n.className || "", lineType: n.lineType});
    ...
    function O(t, e, i, n) {
        var a = t - e, s = p("rect", {
            className: "bar mini",
            styles: {fill: "rgba(228, 234, 239, 0.49)", stroke: _t, "stroke-dasharray": i + ", " + a},
            x: 0,
            y: 0,
            width: i,
            height: a
            ...
            "text-anchor": "start",
            innerHTML: n + ""
        }), l = p("g", {transform: "translate(0, " + e + ")"});
        return l.appendChild(s), l.appendChild(r), l
    }

    function C(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "", s = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0, r = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : 0, o = arguments.length > 7 && void 0 !== arguments[7] ? arguments[7] : {}, l = h(e, o.zeroLine), c = xt(l, 2), u = c[0], d = c[1], f = p("rect", {
            className: "bar mini",
            style: "fill: " + n,
            "data-point-index": s,
            x: t,
        ...
        if ((a += "") || a.length) {
            ...
            var v = p("text", {
                ...
                "text-anchor": "middle",
                innerHTML: a
            }), g = p("g", {"data-point-index": s, transform: "translate(" + t + ", " + d + ")"});
    ...
    function _(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "", s = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : 0, r = p("circle", {
            style: "fill: " + n,
            "data-point-index": s,
            cx: t,
            cy: e,
        ...
        if ((a += "") || a.length) {
            ...
            var o = p("text", {
                ...
                "text-anchor": "middle",
                innerHTML: a
            }), l = p("g", {"data-point-index": s, transform: "translate(" + t + ", " + e + ")"});
    ...
    function N(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {}, a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : {}, s = e.map(function (e, i) {
            return t[i] + "," + e
        }).join("L"), r = m("M" + s, "line-graph-path", i);
        if (n.heatline) {
            var o = x(a.svgDefs, i);
        ...
        var l = {path: r};
        if (n.regionFill) {
            var h = x(a.svgDefs, i, !0), c = "M" + t[0] + "," + a.zeroLine + "L" + s + "L" + t.slice(-1)[0] + "," + a.zeroLine;
    ...
    function S(t, e) {
        var i = Et(t), n = !1;
        "#" == i[0] && (i = i.slice(1), n = !0);
        var a = parseInt(i, 16), s = D((a >> 16) + e), r = D((a >> 8 & 255) + e), o = D((255 & a) + e);
    ...
    function j(t, e, i, n) {
        ...
        return [t, {transform: i.join(", ")}, n, Gt, "translate", {transform: a}]
    }
    ...
    function R(t, e, i, n) {
        var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0, s = h(i, (arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {}).zeroLine), r = xt(s, 2), o = r[0], l = r[1];
        return l -= a, "rect" !== t.nodeName ? [[t.childNodes[0], {
            width: n,
            height: o
        }, Ht, Gt], j(t, t.getAttribute("transform").split("(")[1].slice(0, -1), [e, l], Yt)] : [[t, {
            width: n,
            height: o,
            x: e,
            y: l
    ...
    function Y(t, e, i) {
        return "circle" !== t.nodeName ? [j(t, t.getAttribute("transform").split("(")[1].slice(0, -1), [e, i], Yt)] : [[t, {
            cx: e,
            cy: i
        }, Ht, Gt]]
    }
    ...
    function I(t, e, i, n) {
        var a = [], s = i.map(function (t, i) {
            return e[i] + "," + t
        }).join("L"), r = [t.path, {d: "M" + s}, Rt, Gt];
        if (a.push(r), t.region) {
            var o = e[0] + "," + n + "L", l = "L" + e.slice(-1)[0] + ", " + n, h = [t.region, {d: "M" + o + s + l}, Rt, Gt];
            a.push(h)
        }
        return a
    }
    ...
    function V(t, e, i) {
        var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "linear", a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : void 0, s = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {}, r = t.cloneNode(!0), o = t.cloneNode(!0);
        for (var l in e) {
            var h = void 0;
            ...
            var c = s[l] || t.getAttribute(l), u = e[l], p = {
                attributeName: l,
                from: c,
                to: u,
                begin: "0s",
    ...
    function B(t, e) {
        ...
        e.map(function (t) {
            ...
            t[0] = e;
            var o = V.apply(void 0, kt(t)), l = xt(o, 2);
    ...
    function X(t, e, i) {
        ...
        return Object.assign(a, {constants: e, getData: i}), new Xt(a)
    }
    ...
    function et(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, i = Math.ceil(t), n = Math.floor(e), a = i - n, s = a, r = 1;
    ...
    function it(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, i = tt(t), n = xt(i, 2), a = n[0], s = n[1], r = e ? e / Math.pow(10, s) : 0, o = et(a = a.toFixed(6), r);
    ...
    function nt(t) {
        ...
        var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], n = Math.max.apply(Math, kt(t)), a = Math.min.apply(Math, kt(t)), s = [];
        if (n >= 0 && a >= 0)tt(n)[1], s = i ? it(n, a) : it(n); else if (n > 0 && a < 0) {
            var r = Math.abs(a);
    ...
    function pt(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], i = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2], n = t / e.length / Pt;
    ...
    function dt() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "line", e = arguments[1], i = arguments[2];
    ...
    var wt = function () {
        ...
        return gt(e, [{
            ...
            key: "fill", value: function () {
                ...
                this.index && this.container.setAttribute("data-point-index", this.index), i = this.titleValueFirst ? "<strong>" + this.titleValue + "</strong>" + this.titleName : this.titleName + "<strong>" + this.titleValue + "</strong>", this.title.innerHTML = i, this.dataPointList.innerHTML = "", this.listValues.map(function (i, n) {
                    var a = e.colors[n] || "black", s = t.create("li", {
            ...
            key: "setValues", value: function (t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : [], a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : -1;
    ...
    }(), At = 700, Tt = ["line", "bar"], Pt = 7, Lt = Math.PI / 180, Mt = 6, Ot = 4, Ct = 10, _t = "#dadada", Nt = {
        bar: function (t) {
            var e = void 0;
        ...
        "light-grey": "#f0f4f7",
        "dark-grey": "#b8c2cc"
    }, Wt = ["light-blue", "blue", "violet", "red", "orange", "yellow", "green", "light-green", "purple", "magenta", "light-grey", "dark-grey"], Et = function (t) {
        return St[t] || t
    }, jt = ["line", "scatter", "bar", "percentage", "heatmap", "pie"], zt = {
        ...
        percentage: ["pie"],
        heatmap: []
    }, Ht = 350, Rt = 350, Yt = Ht, It = 250, Gt = "easein", Vt = {
        ...
        return gt(e, [{
            ...
            key: "setColors", value: function () {
                var t = this.rawChartArgs, e = "percentage" === t.type || "pie" === t.type ? t.data.labels : t.data.datasets;
                !t.colors || e && t.colors.length < e.length ? this.colors = Wt : this.colors = t.colors, this.colors = this.colors.map(function (t) {
                    return Et(t)
                })
            }
        }, {
            key: "setMargins", value: function () {
            ...
            key: "makeTooltip", value: function () {
                this.tip = new wt({parent: this.chartWrapper, colors: this.colors}), this.bindTooltip()
            }
        }, {
            ...
            key: "render", value: function () {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.components, i = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
            ...
            key: "getDifferentChart", value: function (t) {
        ...
        return mt(n, i), gt(n, [{
            key: "makeChartArea", value: function () {
                this.chartWrapper.className += " graph-focus-margin", this.chartWrapper.style.marginTop = "45px", this.statsWrapper.className += " graph-focus-margin", this.statsWrapper.style.marginBottom = "30px", this.statsWrapper.style.paddingTop = "0px", this.svg = t.create("div", {
                    ...
                    inside: this.svg
                }), this.percentageBar = t.create("div", {className: "progress", inside: this.chart})
            }
        }, {
            key: "render", value: function () {
                var e = this, i = this.state;
                this.grandTotal = i.sliceTotals.reduce(function (t, e) {
                    ...
                    var s = t.create("div", {
                        ...
                        styles: {background: e.colors[a], width: 100 * n / e.grandTotal + "%"}
                    });
                    i.slices.push(s)
                })
            }
            ...
            key: "bindTooltip", value: function () {
                ...
                this.chartWrapper.addEventListener("mousemove", function (n) {
                    ...
                    if (a.classList.contains("progress-bar")) {
                        var s = a.getAttribute("data-index"), r = e(t.chartWrapper), o = e(a), l = o.left - r.left + a.offsetWidth / 2, h = o.top - r.top - 6, c = (t.formattedLabels && t.formattedLabels.length > 0 ? t.formattedLabels[s] : t.state.labels[s]) + ": ", u = (100 * i.sliceTotals[s] / t.grandTotal).toFixed(1);
                        t.tip.setValues(l, h, {name: c, value: u + "%"}), t.tip.showTip()
                    }
                })
            }
        }]), n
        ...
        function t(e) {
            var i = e.layerClass, n = void 0 === i ? "" : i, a = e.layerTransform, s = void 0 === a ? "" : a, r = e.constants, o = e.getData, l = e.makeElements, h = e.animateElements;
        ...
        pieSlices: {
            ...
            layerClass: "y axis", makeElements: function (t) {
                ...
                return t.positions.map(function (i, n) {
                    return P(i, t.labels[n], e.constants.width, {mode: e.constants.mode, pos: e.constants.pos})
                })
            }, animateElements: function (t) {
                var e = t.positions, i = t.labels, n = this.oldData.positions, a = this.oldData.labels, s = c(n, e), r = xt(s, 2);
                n = r[0], e = r[1];
                var o = c(a, i), l = xt(o, 2);
            ...
            layerClass: "x axis", makeElements: function (t) {
                var e = this;
                return t.positions.map(function (i, n) {
                    return L(i, t.calcLabels[n], e.constants.height, {mode: e.constants.mode, pos: e.constants.pos})
                })
            }, animateElements: function (t) {
                var e = t.positions, i = t.calcLabels, n = this.oldData.positions, a = this.oldData.calcLabels, s = c(n, e), r = xt(s, 2);
                n = r[0], e = r[1];
                var o = c(a, i), l = xt(o, 2);
            ...
            layerClass: "y-markers", makeElements: function (t) {
                ...
                return t.map(function (t) {
                    return M(t.position, t.label, e.constants.width, {pos: "right", mode: "span", lineType: "dashed"})
                })
            }, animateElements: function (t) {
                var e = c(this.oldData, t), i = xt(e, 2);
                this.oldData = i[0];
            ...
            layerClass: "y-regions", makeElements: function (t) {
                ...
                this.render(r.map(function (t, e) {
                    return {startPos: o[e], endPos: r[e], label: a[e]}
                }));
                var l = [];
            ...
            layerClass: function () {
                ...
                var e = t.xPositions, i = t.yPositions, n = t.offsets, a = t.labels, s = this.oldData.xPositions, r = this.oldData.yPositions, o = this.oldData.offsets, l = this.oldData.labels, h = c(s, e), u = xt(h, 2);
                s = u[0], e = u[1];
                var p = c(r, i), d = xt(p, 2);
                r = d[0], i = d[1];
                var f = c(o, n), v = xt(f, 2);
                o = v[0], n = v[1];
                var g = c(l, a), y = xt(g, 2);
                ...
                return this.store.map(function (a, s) {
                    m = m.concat(R(a, e[s], i[s], t.barWidth, n[s], {zeroLine: t.zeroLine}))
                }), m
            }
        }, lineGraph: {
            layerClass: function () {
                ...
                var e = this.constants;
                return this.unitType = "dot", this.paths = {}, e.hideLine || (this.paths = N(t.xPositions, t.yPositions, e.color, {
                    heatline: e.heatline,
                    ...
                    return _(t.xPositions[n], i, t.radius, e.color, e.valuesOverPoints ? t.values[n] : "", n)
                })), Object.values(this.paths).concat(this.units)
            }, animateElements: function (t) {
                var e = t.xPositions, i = t.yPositions, n = t.values, a = this.oldData.xPositions, s = this.oldData.yPositions, r = this.oldData.values, o = c(a, e), l = xt(o, 2);
                a = l[0], e = l[1];
                var h = c(s, i), u = xt(h, 2);
                s = u[0], i = u[1];
                var p = c(r, n), d = xt(p, 2);
        ...
        return mt(i, t), gt(i, [{
            ...
            key: "calcSlices", value: function () {
                var t = this, e = this.state, i = this.radius, n = this.clockWise, a = e.slicesProperties || [];
                e.sliceStrings = [], e.slicesProperties = [];
                var s = 180 - this.config.startAngle;
                e.sliceTotals.map(function (r, o) {
                    var h = s, c = r / e.grandTotal * 360, u = n ? -c : c, p = s += u, d = l(h, i), f = l(p, i), v = t.init && a[o], g = void 0, y = void 0;
            ...
            key: "calTranslateByAngle", value: function (t) {
                var e = this.radius, i = this.hoverRadio, n = l(t.startAngle + t.angle / 2, e);
            ...
            key: "hoverSlice", value: function (t, i, n, a) {
                if (t) {
                    ...
                    if (n) {
                        ...
                        var r = e(this.svg), o = a.pageX - r.left + 10, l = a.pageY - r.top - 10, h = (this.formatted_labels && this.formatted_labels.length > 0 ? this.formatted_labels[i] : this.state.labels[i]) + ": ", c = (100 * this.state.sliceTotals[i] / this.state.grandTotal).toFixed(1);
                        this.tip.setValues(o, l, {name: h, value: c + "%"}), this.tip.showTip()
            ...
            key: "mouseMove", value: function (t) {
                var e = t.target, i = this.components.get("pieSlices").store, n = this.curActiveSliceIndex, a = this.curActiveSlice;
                if (i.includes(e)) {
                    var s = i.indexOf(e);
        ...
        return mt(e, t), gt(e, [{
            ...
            key: "validate_colors", value: function (t) {
            ...
            key: "calc", value: function () {
                var t = this, e = Object.keys(this.data).map(function (e) {
                    return t.data[e]
                });
            ...
            key: "renderAllWeeksAndStoreXValues", value: function (t) {
                ...
                for (var i = 0; i < t; i++) {
                    var n = void 0, a = 0, s = new Date(e), r = this.get_week_squares_group(s, this.weekCol), o = xt(r, 2);
            ...
            key: "get_week_squares_group", value: function (t, e) {
                for (var i = this.today.getTime(), n = 0, a = 0, s = y(this.dataGroups, "data-group"), r = 0, o = 0; o < 7; o += 1, r += 12) {
                    var l = 0, h = 0, c = t.getTime() / 1e3, u = Math.floor(c - c % 86400).toFixed(1);
            ...
            key: "render_month_labels", value: function () {
                var t = this;
            ...
            key: "bindTooltip", value: function () {
                ...
                Array.prototype.slice.call(document.querySelectorAll(".data-group .day")).map(function (e) {
                    e.addEventListener("mouseenter", function (e) {
                        var i = e.target.getAttribute("data-value"), n = e.target.getAttribute("data-date").split("-"), a = t.monthNames[parseInt(n[1]) - 1].substring(0, 3), s = t.chartWrapper.getBoundingClientRect(), r = e.target.getBoundingClientRect(), o = parseInt(e.target.getAttribute("width")), l = r.left - s.left + (o + 2) / 2, h = r.top - s.top - (o + 2) / 2, c = i + " " + t.countLabel, u = " on " + a + " " + n[0] + ", " + n[2];
                        t.tip.setValues(l, h, {name: u, value: c, valueFirst: 1}, []), t.tip.showTip()
                    })
                })
            }
        }, {
        ...
        return mt(n, i), gt(n, [{
            ...
            key: "calcYAxisParameters", value: function (t) {
                var e = nt(t, arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "false"), i = this.height / rt(e), n = st(e) * i, a = this.height - at(e) * n;
                this.state.yAxis = {
            ...
            key: "setupComponents", value: function () {
                var t = this, e = [["yAxis", {mode: this.config.yAxisMode, width: this.width}, function () {
                    ...
                    return ["barGraph-" + e.index, {
                        ...
                        var t = this.state, e = t.datasets[n], a = this.barOptions.stacked, s = this.barOptions.spaceRatio || .5, r = t.unitWidth * (1 - s), o = r / (a ? 1 : i.length), l = t.xAxis.positions.map(function (t) {
                            return t - r / 2
                        });
            ...
            key: "bindTooltip", value: function () {
                ...
                this.chartWrapper.addEventListener("mousemove", function (i) {
                    var n = e(t.chartWrapper), a = i.pageX - n.left - t.leftMargin;
            ...
            key: "mapTooltipXPosition", value: function (t) {
                var e = this, i = this.state;
                if (i.yExtremes) {
                    var n = this.config.formatTooltipY, a = this.config.formatTooltipX, s = i.xAxis.labels;
                    ...
                    for (var r = i.datasetLength - 1; r >= 0; r--) {
                        ...
                        if (t > o - i.unitWidth / 2) {
                            var l = o + this.leftMargin, h = i.yExtremes[r] + this.translateY, c = this.data.datasets.map(function (t, i) {
                                return {title: t.name, value: n ? n(t.values[r]) : t.values[r], color: e.colors[i]}
                            });
                            this.tip.setValues(l, h, {name: s[r], value: ""}, c, r), this.tip.showTip();
                            break
                        }
                    }
                }
            ...
            key: "makeOverlay", value: function () {
                ...
                this.overlayGuides && this.overlayGuides.forEach(function (t) {
                    ...
                    e.overlay = Nt[e.type](i), t.drawArea.appendChild(e.overlay)
                })
            }
        }, {
    ...
    }(qt), Zt = {percentage: Ut, heatmap: $t, pie: Kt}, te = function t(e, i) {
