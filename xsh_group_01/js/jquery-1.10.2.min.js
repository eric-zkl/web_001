...
$(".scroll").click(function (b) {
    ...
    $("html,body").animate({scrollTop: a}, 1000, "swing")
});
$(function () {
    $("#btnSend").click(function () {
        $.ajax({
            type: "POST", data: $("#frmContact").serialize(), success: function (a) {
                $("#spanMessage").html("Please Wait...");
                if (parseInt(a) > 0) {
                    $("#spanMessage").html('<div class="alert-success"><strong>Done! </strong> Your message has been sent.</div>')
                } else {
                    alert(a);
                    $("#spanMessage").html('<div class="alert-error"><strong>Error! </strong> Somthing is Wrong!</div>')
                }
            }
        })
    });
    $("#btnSubmit").click(function () {
        $.ajax({
            type: "POST", data: $("#frmnotify").serialize(), success: function (a) {
                $("#submitMessage").html("Please Wait...");
                if (parseInt(a) > 0) {
                    $("#submitMessage").html('<div class="alert-success"><strong>Done! </strong> Successfully submitted</div>')
                } else {
                    alert(a);
                    $("#submitMessage").html('<div class="alert-error"><strong>Error! </strong> Somthing is Wrong!</div>')
                }
            }
        })
    });
    $("#wdSubmit").click(function () {
        $.ajax({
            type: "POST", data: $("#worldtry").serialize(), success: function (a) {
                $("#worldtry #submitMessage").html("Please Wait...");
                if (parseInt(a) > 0) {
                    $("#worldtry #submitMessage").html('<div class="alert-success"><strong>Done! </strong> Successfully submitted</div>')
                } else {
                    alert(a);
                    $("#worldtry #submitMessage").html('<div class="alert-error"><strong>Error! </strong> Somthing is Wrong!</div>')
                }
            }
        })
    })
